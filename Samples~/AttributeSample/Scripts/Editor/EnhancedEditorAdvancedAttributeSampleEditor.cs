...
{
    [CustomEditor(typeof(EnhancedEditorAdvancedAttributeSample)), CanEditMultipleObjects]
    public class EnhancedEditorAdvancedAttributeSampleEditor : UnityObjectEditor
    {
        #region Editor GUI
        ...
        private EnhancedEditorAdvancedAttributeSample sample = null;
        ...
        {
            base.OnEnable();
            sample = target as EnhancedEditorAdvancedAttributeSample;
        }
