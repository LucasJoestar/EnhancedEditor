...
namespace EnhancedEditor.Editor {
    ...
    public class RequiredPropertyDrawer : EnhancedPropertyDrawer {
        ...
        public override void OnEnable() {
            ...
            SerializedProperty _property = SerializedProperty;

            if ((_property.propertyType == SerializedPropertyType.ObjectReference) && !_property.objectReferenceValue &&
                EnhancedEditorGUI.GetRequiredObject(id, _property, out Object _value)) {
