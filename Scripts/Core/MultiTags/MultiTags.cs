...
namespace EnhancedEditor {
    ...
    public static class MultiTags {
        ...
        #region Utility
        /// <inheritdoc cref="TagDatabase.DoesTagExist(string)"/>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool DoesTagExist(string _name) {
            return Database.DoesTagExist(_name);
        }

        /// <inheritdoc cref="TagDatabase.DoesTagExist(long)"/>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool DoesTagExist(long _id) {
            return Database.DoesTagExist(_id);
        }
