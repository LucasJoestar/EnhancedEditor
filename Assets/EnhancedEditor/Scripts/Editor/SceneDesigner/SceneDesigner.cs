...
public class SceneDesigner : EditorWindow
{
	...
	*/
    ...
    /// </summary>
    //[MenuItem("Tools/Scene Designer")]
    public static void CallWindow()
    {
        GetWindow<SceneDesigner>("Scene Designer", true).Show();
    }
    #endregion
    ...
    private void OnDisable()
    {
        ...
        string _datas = JsonUtility.ToJson(this, false);
        EditorPrefs.SetString("SceneDesigner", _datas);
    }
    ...
    private void OnEnable()
    {
        ...
        string _datas = EditorPrefs.GetString("SceneDesigner", JsonUtility.ToJson(this));
        JsonUtility.FromJsonOverwrite(_datas, this);
    }
...
public class PlaceableSelectionWindow : EditorWindow
{
    ...
    */
    ...
    private SceneDesigner sceneDesigner = null;
    ...
    public void Init(SceneDesigner _sceneDesigner, Rect _buttonRect, Vector2 _size)
    {
